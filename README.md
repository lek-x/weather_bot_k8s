[![Pre-commit](https://github.com/lek-x/weather_bot_k8s/actions/workflows/pre-commit-config.yaml/badge.svg?event=check_run)](https://github.com/lek-x/weather_bot_k8s/actions/workflows/pre-commit-config.yaml)
